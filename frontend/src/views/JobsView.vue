        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-6 flex gap-4 flex-wrap">
                <div class="relative flex-1 min-w-[250px]">
                    ...
                    <input
                        ...
                        class="w-full pl-10 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-shadow duration-200"
                    />
                    <button
                        v-if="search"
                        @click="search = ''"
                ...
                <div class="flex items-center gap-2">
                    ...
                    <select
                        ...
                        class="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-shadow duration-200"
                    >
            ...
            <div v-else class="space-y-4">
                ...
                <div
                    ...
                    class="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow cursor-pointer border border-gray-100"
                >
            ...
            <div class="mt-8 flex justify-center gap-4 items-center flex-wrap">
                <button
                    ...
                    @click="page--"
                    class="px-4 py-2 bg-white border border-gray-300 rounded-md disabled:opacity-50 hover:bg-gray-50 transition-colors flex items-center gap-2"
                >
